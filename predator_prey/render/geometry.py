    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.shape == Shape.CIRCLE:
            ...
            self.center_point = pyglet.shapes.Circle(
                self.x, self.y, 2, color=(0, 0, 0), batch=batch
            )
            self.object = pyglet.shapes.Circle(
                self.x, self.y, radius, color=self.color, batch=batch
            )
